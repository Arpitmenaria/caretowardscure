				...
				<div class="contact-wrapper">
					<div class="contact-info">
						<div class="clinic-details">
							...
							<div class="contact-item">
								...
								<div class="contact-details">
									<p class="contact-label"><a href="https://www.google.com/maps/@26.8666793,75.7812467,18z" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; cursor: pointer; font-weight: 600;"><?php esc_html_e( 'Triveni Nagar Branch', 'care-towards-cure' ); ?></a></p>
									<p class="contact-value">
										<a href="https://www.google.com/maps/@26.8666793,75.7812467,18z" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; cursor: pointer;">
						...
						<div class="contact-item">
							...
							<div class="contact-details">
								<p class="contact-label"><a href="https://www.google.com/maps/@26.8116667,75.8233333,18z" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; cursor: pointer; font-weight: 600;"><?php esc_html_e( 'Gangori Bazar Branch', 'care-towards-cure' ); ?></a></p>
								<p class="contact-value">
									<a href="https://www.google.com/maps/@26.8116667,75.8233333,18z" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; cursor: pointer;">
